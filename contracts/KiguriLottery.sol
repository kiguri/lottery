...
/** @title Kiguri Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract KiguriLottery is ReentrancyGuard, IKiguriLottery, Ownable {
  ...
  uint256 public constant MIN_LENGTH_LOTTERY = 20 minutes - 5 minutes; // 20 minutes
